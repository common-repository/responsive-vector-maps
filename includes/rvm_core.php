...
{
    load_plugin_textdomain( 'responsive-vector-maps', false, dirname( RVM_PLUGIN_FILE ) . '/languages/' );
}
// Fields input arrays 
function rvm_fields_array()
{
    ...
    $fields[ 'rvm_mbe_select_map' ] = array(
         'rvm_mbe_select_map',
        'select',
        esc_html__( 'Select Map', 'responsive-vector-maps' ),
        '',
        '',
        10,
        1,
    ...
    $fields[ 'rvm_mbe_zoom' ] = array(
         'rvm_mbe_zoom',
        'checkbox',
        esc_html__( 'Zoom buttons', 'responsive-vector-maps' ),
        '',
        '',
        '',
        1,
    ...
    $fields[ 'rvm_mbe_width' ] = array(
         'rvm_mbe_width',
        'text',
        __( 'Map Width', 'responsive-vector-maps' ),
        __( '( You can use em, %, px , rem. Leave it blank for a responsive map )', 'responsive-vector-maps' ),
        '',
        10,
        1,
        'main',
    ...
    $fields[ 'rvm_mbe_map_padding' ] = array(
         'rvm_mbe_map_padding',
        'text',
        __( 'Map Padding', 'responsive-vector-maps' ),
        __( '( You can use em, %, px , rem. Leave it blank for default behaviour )', 'responsive-vector-maps' ),
        '',
        10,
        1,
        'main',
    ...
    $fields[ 'rvm_mbe_map_transparent_canvas' ] = array(
        ...
        'checkbox',
        __( 'Transparent Canvas', 'responsive-vector-maps' ),
        '',
        '',
        '',
        1,
    ...
    $fields[ 'rvm_mbe_map_canvascolor' ] = array(
        ...
        'text',
        __( 'Canvas  Colour', 'responsive-vector-maps' ),
        '',
        7,
        7,
        1,
    ...
    $fields[ 'rvm_mbe_map_bgcolor' ] = array(
         'rvm_mbe_map_bgcolor',
        'text',
        __( 'Map Colour', 'responsive-vector-maps' ),
        '',
        7,
        7,
        1,
    ...
    $fields[ 'rvm_mbe_map_bordercolor' ] = array(
        ...
        'text',
        __( 'Borders Color', 'responsive-vector-maps' ),
        '',
        7,
        7,
        1,
    ...
    $fields[ 'rvm_mbe_border_width' ] = array(
        ...
        'text',
        __( 'Borders width', 'responsive-vector-maps' ),
        __( 'px ( accepts decimal separated by a dot i.e.: 0.5 )', 'responsive-vector-maps' ),
        5,
        5,
        1,
        'main',
    ...
    $fields[ 'rvm_mbe_subdivision_background_selected_status' ] = array(
        ...
        'checkbox',
        __( 'Enable Subdivision Selected Status', 'responsive-vector-maps' ),
        '',
        '',
        '',
        1,
    ...
    $fields[ 'rvm_mbe_map_bg_selected_color' ] = array(
        ...
        'text',
        __( 'Subdivisions Selected  Colour', 'responsive-vector-maps' ),
        '',
        7,
        7,
        1,
    ...
    $fields[ 'rvm_mbe_regions_mouseover_colour' ] = array(
        ...
        'text',
        __( 'Subdivisions Hover Colour', 'responsive-vector-maps' ),
        '',
        7,
        7,
        1,
    ...
    $fields[ 'rvm_mbe_regions_mouseover_colour_opacity' ] = array(
        ...
        'text',
        __( 'Subdivisions Hover Colour Opacity', 'responsive-vector-maps' ),
        __( 'value must be between 0 and 1 i.e.: 0.5', 'responsive-vector-maps' ),
        3,
        3,
        1,
        'main',
    ...
    $fields[ 'rvm_mbe_map_get_rid_of_sub_names' ] = array(
        ...
        'checkbox',
        __( 'Get rid of Subdivisions names', 'responsive-vector-maps' ),
        __( 'When checked, Subdivisions names will not be displayed when mouse hovers over subdivisions on front end', 'responsive-vector-maps' ),
        '',
        '',
        1,
        'main',
    ...
    $fields[ 'rvm_mbe_enable_link_target' ] = array(
        ...
        'checkbox',
        __( 'Links target ', 'responsive-vector-maps' ),
        __( 'Open all url in a new window', 'responsive-vector-maps' ),
        '',
        '',
        1,
        'main',
    ...
    $fields[ 'rvm_mbe_map_marker_bg_color' ] = array(
        ...
        'text',
        __( 'Markers Background Color', 'responsive-vector-maps' ),
        '',
        7,
        7,
        1,
    ...
    $fields[ 'rvm_mbe_map_marker_border_color' ] = array(
        ...
        'text',
        __( 'Markers Border Color', 'responsive-vector-maps' ),
        '',
        7,
        7,
        1,
    ...
    $fields[ 'rvm_mbe_map_marker_dim_min' ] = array(
        ...
        'select',
        __( 'Minimum Value', 'responsive-vector-maps' ),
        '',
        '',
        '',
        1,
    ...
    $fields[ 'rvm_mbe_map_marker_dim_max' ] = array(
        ...
        'select',
        __( 'Maximum Value', 'responsive-vector-maps' ),
        '',
        '',
        '',
        1,
    ...
    $fields[ 'rvm_mbe_map_markers_rain_effect' ] = array(
        ...
        'checkbox',
        __( 'Markers rain', 'responsive-vector-maps' ),
        __( 'When checked, Markers pinpoints will fall down from top of the map on scrolling', 'responsive-vector-maps' ),
        '',
        '',
        1,
        'markers' 
...
function rvm_countries_array()
{
    ...
    $countries[ 'italy' ] = array(
        'italy',
         __( 'Italy', 'responsive-vector-maps' ),
    ...
    $countries[ 'world' ] = array(
        'world',
        __( 'World', 'responsive-vector-maps' ),
...
function rvm_post_type()
{
    ...
    register_post_type( 'rvm', array(
         'labels' => array(
             'name' => esc_html__( 'RVM - Maps' ),
            'singular_name' => esc_html__( 'RVM Singular Name', 'responsive-vector-maps' ),
            'add_new' => esc_html__( 'Add New Map', 'responsive-vector-maps' ),
            'add_new_item' => esc_html__( 'Add New Map', 'responsive-vector-maps' ),
            'edit_item' => esc_html__( 'Edit Map', 'responsive-vector-maps' ),
            'new_item' => esc_html__( 'New Map', 'responsive-vector-maps' ),
            'view_item' => esc_html__( 'View This Map', 'responsive-vector-maps' ),
            'search_items' => esc_html__( 'Search Maps', 'responsive-vector-maps' ),
            'not_found' => esc_html__( 'No Maps Found', 'responsive-vector-maps' ),
            'not_found_in_trash' => esc_html__( 'No Maps Found in Trash', 'responsive-vector-maps' ),
            'parent_item_colon' => esc_html__( 'Parent Maps Colon', 'responsive-vector-maps' ),
            'menu_name' => esc_html__( 'RVM Maps', 'responsive-vector-maps' ) 
        ),
        'description' => esc_html__( 'Responsive Vector Map Wherever You Like', 'responsive-vector-maps' ),
        'public' => true,
        'has_archive' => true,
...
{
    add_meta_box( 'rvm_meta', esc_html__( 'Settings For:', 'responsive-vector-maps' ) . '&nbsp;' . get_the_title(), 'rvm_mb_function', 'rvm', 'normal', 'high' );
}
...
function rvm_mb_function( $post )
{
    ...
    $output .= '<div id="rvm_tabs"><ul><li id="rvm_main_settings_tab" class="rvm_tabs ' . $rvm_tab_class_main_settings . '" rel="rvm_main_settings"><a href="#">' . esc_html__( 'Main Settings ', 'responsive-vector-maps' ) . '</a></li>';
    if ( !empty( $rvm_selected_map ) ) {
        ...
        $output .= '<li id="rvm_regions_countries_tab" class="rvm_tabs ' . $rvm_tab_class_region_countries . '" rel="rvm_regions_countries"><a href="#">' . esc_html__( 'Subdivisions ', 'responsive-vector-maps' ) . '</a></li>';
        $output .= '<li id="rvm_markers_tab" class="rvm_tabs  ' . $rvm_tab_class_markers . '" rel="rvm_markers"><a href="#">' . esc_html__( 'Markers ', 'responsive-vector-maps' ) . '</a></li>';
    } //if( !empty( $rvm_selected_map ) )
    $output .= '</ul></div>';
    /**************** Start: Main settings *****************/
    ...
    if ( rvm_is_custom_map( $post->ID ) ) {
        ...
        if ( !empty( $rvm_custom_maps_options ) && !empty( $rvm_custom_map_name ) ) {
            ...
            if ( !rvm_is_map_in_download_dir_yet( $rvm_custom_map_dir_path, $rvm_custom_map_name ) ) {
                $output .= '<div>';
                $output .= '<p class="rvm_messages"><img  src="' . RVM_IMG_PLUGIN_DIR . '/warning-icon.png" alt="check" /><span>' . esc_html__( 'It seems custom map is not in upload dir anymore', 'responsive-vector-maps' ) . '</span></p>';
                $output .= '<p><strong>' . esc_html__( 'Please, do not click on "Update" ', 'responsive-vector-maps' ) . '</strong></p>';
                $output .= '<p>' . esc_html__( 'This is the path where custom map should be :  ', 'responsive-vector-maps' ) . $rvm_custom_map_dir_path . '</p>';
                $output .= '<p>' . esc_html__( 'Please remove this map from posts / pages / widgets ', 'responsive-vector-maps' ) . '</p>';
                $output .= '<p>' . esc_html__( 'In order to use this map upload again using the media uploader and use "Add Custom Map" in the select drop down ', 'responsive-vector-maps' ) . '</p>';
                $output .= '</div>';
            } // if ( $rvm_is_map_in_download_dir_yet )                        
        } // if ( !empty( $rvm_custom_maps_options ) && !empty( $rvm_custom_map_name ) ) 
    } //if ( rvm_is_custom_map( $post->ID ) )
    elseif ( rvm_is_custom_map_plugin_path_system( $post->ID ) ) {
        ...
        if ( ( $screen->action != 'add' ) && isset( $array_regions ) && empty( $array_regions ) ) {
            $output .= '<div class="rvm_messages rvm_error_messages rvm_message_map_not_available">' . esc_html__( 'Sorry, this map is no longer available by default.<br>', 'responsive-vector-maps' );
            $output .= '<a href="' . RVM_DOMAIN_URL . 'redirect-from-map-to-purchase-user-site/" target="_blank" class="rvm_download_custom_map">' . esc_html__( 'You can now download map here', 'responsive-vector-maps' ) . '</a>';
            $output .= '</div>';
        }
    }
    ...
    foreach ( $array_fields as $field ) {
        ...
        $id_and_class = 'id="' . $field[ 0 ] . '" class="' . RVM_PREFIX . $field[ 1 ] . '" '; //add specific id and classes for fields
        if ( $field[ 7 ] == 'main' ) {
            $output .= '<p ';
            if ( $field[ 1 ] == 'text' ) {
                $output .= 'class="' . RVM_PREFIX . $field[ 8 ] . '" >'; // close tag p specifying the class
                ...
                $field[ 3 ] = !empty( $field[ 3 ] ) ?  '<span class="rvm_field_descr rvm_notice_messages">' . $field[ 3 ] . '</span>' : '';
                $output .= ' />&nbsp;' . $field[ 3 ];
                ...
                if ( $field[ 0 ] == 'rvm_mbe_map_bg_selected_color' ) {
                    $output .= '<h2 class="rvm_h2_title rvm_hidden_when_custom_map">' . esc_html__( 'Subdivisions Hover Status', 'responsive-vector-maps' ) . '</h2>';
                } else if ( $field[ 0 ] == 'rvm_mbe_border_width' ) {
                    $output .= '<h2 class="rvm_h2_title rvm_hidden_when_custom_map">' . esc_html__( 'Subdivisions Selected Status', 'responsive-vector-maps' ) . '</h2>';
                }
                /*else if( $field[ 0 ] == 'rvm_mbe_regions_mouseover_colour_opacity' ) {
                $output .= '<h2 class="rvm_h2_title rvm_hidden_when_custom_map">' . __('General Link Settings' , 'responsive-vector-maps' ) . '</h2>' ;
                }*/
            } // if( $field[ 1 ] == 'text' )
            if ( $field[ 1 ] == 'select' ) {
                if ( $field[ 0 ] == 'rvm_mbe_select_map' ) {
                    ...
                    if ( empty( $field_value ) ) { // If is a new map and we have no value create the select                
                        ...
                        $output .= '<option value="select_country" ' . selected( '', $field_value, false ) . '>' . esc_html__( 'Select...', 'responsive-vector-maps' ) . '</option>';
                        //$output .= '<option value="rvm_custom_map" id="rvm_add_custom_map">' . __( 'Add Custom Map &raquo;', 'responsive-vector-maps' ) . '</option>';
                        foreach ( $array_countries as $country_field ) {
                            if ( $country_field[ 5 ] === 'custom_maps' ) {
                                $output .= '<optgroup label="' . esc_html__( 'Custom Maps', 'responsive-vector-maps' ) . '" >';
                                break;
                        ...
                        $output .= '<optgroup label="' . esc_html__( 'Default Maps', 'responsive-vector-maps' ) . '" >';
                        ...
                        $output .= '<label for="' . $field[ 0 ] . '" ' . RVM_LABEL_CLASS . '>' . esc_html__( 'Selected Map', 'responsive-vector-maps' ) . '</label>';
                        if ( rvm_is_custom_map( $post->ID ) ) {
                            $rvm_custom_map_name = get_post_meta( $post->ID, '_rvm_mbe_select_map', true );
            ...
            if ( $field[ 1 ] == 'checkbox' ) {
                ...
                if ( $field[ 0 ] == 'rvm_mbe_map_get_rid_of_sub_names' ) {
                    $output .= '<h2 class="rvm_h2_title rvm_hidden_when_custom_map">' . esc_html__( 'General Link Settings', 'responsive-vector-maps' ) . '</h2>';
                }
            } //$field[1] == 'checkbox'
            $output .= '</p>';
        } //if( $field[ 7 ] == 'main' )
    ...
    $output .= '<span id="' . RVM_PREFIX . 'ajax_nonce" class="hidden" style="visibility: hidden;">' . wp_create_nonce( 'rvm_ajax_nonce' ) . '</span>';
        ...
        if ( !empty( $rvm_custom_maps_options ) ) {
            ...
            foreach ( $rvm_custom_maps_options as $key => $value ) {
                if ( $rvm_selected_map == $key ) {
                    ...
                    if ( $rvm_is_map_in_download_dir_yet && rvm_maps_is_already_in_db( $post->ID ) && current_user_can( 'manage_options' ) ) {
                        $output .= '<div class="rvm_clear_both"></div>';
                        $output .= '<input type="button" id="preview_button" class="button-primary  ' . RVM_PREFIX . 'hidden_when_custom_map"  value=" ' . __( 'Map Preview ( update post first )', 'responsive-vector-maps' ) . '" />';
                        $output .= '<input type="button" id="close_preview_button" class="button-primary rvm_hide" value=" ' . __( 'Close Map Preview', 'responsive-vector-maps' ) . '" />';
                    } // if ( $rvm_is_map_in_download_dir_yet )
                } // if( $rvm_selected_map == $key )
            } // foreach ( $rvm_custom_maps_options as $key => $value )
        } //if ( !empty( $rvm_custom_maps_options ) )
    } // if( !empty( $rvm_selected_map ) && rvm_is_custom_map( $post->ID ) )
    elseif ( rvm_maps_is_already_in_db( $post->ID ) && current_user_can( 'manage_options' ) ) {
        $output .= '<div class="rvm_clear_both"></div>';
        $output .= '<input type="button" id="preview_button" class="button-primary  ' . RVM_PREFIX . 'hidden_when_custom_map"  value=" ' . __( 'Map Preview ( update post first )', 'responsive-vector-maps' ) . '" />';
        $output .= '<input type="button" id="close_preview_button" class="button-primary rvm_hide" value=" ' . __( 'Close Map Preview', 'responsive-vector-maps' ) . '" />';
    }    
        ...
        $output .= '<div id="rvm_shortcode" class="updated"><p>' . __( 'Copy and paste following shortcode to display this map wherever you like ( only once per post/sidebar per page ) :', 'responsive-vector-maps' ) . '<span id="rvm_shortcode_to_copy"> <strong>[rvm_map mapid="' . $post->ID . '"]</strong></span> .</p></div>';
        $output .= '<div class="updated"><p>' . __( 'In order to see the map using the "View post" link of this page, please <strong>copy and paste</strong> the shortcode into the editor and save the post. If you get a 404 just go to "Settings" > "Permalinks" and save again your settings', 'responsive-vector-maps' ) . '.</p></div>';
        // $output .= '<div id="rvm_donation" class="updated"><p>' . __( 'Help us to keep RVM free... support <strong>RVM</strong> now', 'responsive-vector-maps' ) . '<a class="rvm_donate_link" href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=info%40responsivemapsplugin%2ecom&lc=IT&item_name=responsive%20Vector%20Maps%20Plugin&item_number=rvm%2dplugin%2dwordpress%2dadmin&currency_code=EUR&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted" target="_blank">
    ...
    echo wp_kses( $output, rvm_allowed_tags( 'core' ) ); // echo the fields
    ...
    if ( ( isset( $_POST[ 'rvm_mbe_select_map' ] ) && $_POST[ 'rvm_mbe_select_map' ] != 'select_country' ) || ( isset( $_POST[ 'rvm_custom_map_filename' ] ) && !empty( $_POST[ 'rvm_custom_map_filename' ] ) ) ) {
        foreach ( $array_fields as $field ) {
            if ( isset( $_POST[ $field[ 0 ] ] ) ) {
                ...
                if ( $field[ 0 ] == 'rvm_mbe_zoom' || $field[ 0 ] == 'rvm_mbe_subdivision_background_selected_status' || $field[ 0 ] == 'rvm_mbe_map_transparent_canvas' || $field[ 0 ] == 'rvm_mbe_enable_link_target' || $field[ 0 ] == 'rvm_mbe_map_markers_rain_effect' || $field[ 0 ] == 'rvm_mbe_map_get_rid_of_sub_names' ) {
                ...
                update_post_meta( $post_id, '_' . $field[ 0 ], sanitize_text_field( $_POST[ $field[ 0 ] ] ) );
            } // if( isset( $_POST[ $field[ 0 ] ] )
            else if ( $field[ 0 ] == 'rvm_mbe_zoom' || $field[ 0 ] == 'rvm_mbe_subdivision_background_selected_status' || $field[ 0 ] == 'rvm_mbe_map_transparent_canvas' || $field[ 0 ] == 'rvm_mbe_enable_link_target' || $field[ 0 ] == 'rvm_mbe_map_markers_rain_effect' || $field[ 0 ] == 'rvm_mbe_map_get_rid_of_sub_names' ) { // if  checkbox not isset means is unchecked
                update_post_meta( $post_id, '_' . $field[ 0 ], 'unchecked' );
            } //$field[0] == 'rvm_mbe_zoom'          
        } //foreach( $array_fields as $field )                     
        /****************  Start: Save region fields to DB *****************/
        $array_regions = rvm_include_custom_map_settings( $post_id, sanitize_text_field( $_POST[ 'rvm_mbe_select_map' ] ) );
        $rvm_region_array_sanitized = [];
        foreach ( $array_regions as $field ) {
            if ( isset( $_POST[ $field[ 1 ] ] ) ) {                
                ...
                // $rvm_region_array_sanitized[ 0 ] = $rvm_region_array[ 0 ];
                // $rvm_region_array_sanitized[ 1 ] = $rvm_region_array[ 1 ];
                // $rvm_region_array_sanitized[ 2 ] = $rvm_region_array[ 2 ];
                // $rvm_region_array_sanitized[ 3 ] = $rvm_region_array[ 3 ];
                // $rvm_region_array_sanitized[ 4 ] = $rvm_region_array[ 4 ];    
                ...
                if ( in_array( "open_link", $rvm_region_array ) || in_array( "open_label_onto_default_card", $rvm_region_array ) || in_array( "show_custom_selector", $rvm_region_array ) ) {
                    ...
                    if ( count( $rvm_region_array ) < 5 ) {
                        ...
                        $rvm_region_array_sanitized[ 4 ] = rvm_sanitize_post_value( $rvm_region_array[ 3 ], '' );
                        //and then re-assign the 'unchecked status' to the checkbox input ( unchecked as it has non been checked )
                        $rvm_region_array_sanitized[ 3 ] = 'unchecked';
                        $rvm_region_array_sanitized[0] = $rvm_region_array_sanitized[ 4 ] === 'open_link' ? rvm_sanitize_post_value( $rvm_region_array[0], 'url' ) : rvm_sanitize_post_value( $rvm_region_array[0], '' );
                        $rvm_region_array_sanitized[ 1 ] = rvm_sanitize_post_value( $rvm_region_array[ 1 ], '' );
                        $rvm_region_array_sanitized[ 2 ] = rvm_sanitize_post_value( $rvm_region_array[ 2 ], 'html' );
                    }
                    //a better way to solve this situation would be replacing checkbox with a select (taking option value of 'checked' and 'uncheked'), but we could not use checkboses anymore or we should need a sort of javascript check before submit
                        ...
                        $rvm_region_array_sanitized[ 3 ] = 'checked';
                        $rvm_region_array_sanitized[0] = $rvm_region_array_sanitized[ 4 ] === 'open_link' ? rvm_sanitize_post_value( $rvm_region_array[0], 'url' ) : rvm_sanitize_post_value( $rvm_region_array[0], '' );
                        $rvm_region_array_sanitized[ 1 ] = rvm_sanitize_post_value( $rvm_region_array[ 1 ], '' );
                        $rvm_region_array_sanitized[ 2 ] = rvm_sanitize_post_value( $rvm_region_array[ 2 ], 'html' );
                        $rvm_region_array_sanitized[ 4 ] = rvm_sanitize_post_value( $rvm_region_array[ 4 ], '' );
                    }
                    ...
                    $rvm_region_array_sanitized[ 3 ] = !empty( $rvm_region_array[ 4 ] ) ? 'checked' : 'unchecked';
                    $rvm_region_array_sanitized[0] = $rvm_region_array_sanitized[ 4 ] === 'open_link' ? rvm_sanitize_post_value( $rvm_region_array[0], 'url' ) : rvm_sanitize_post_value( $rvm_region_array[0], '' );
                    $rvm_region_array_sanitized[ 1 ] = rvm_sanitize_post_value( $rvm_region_array[ 1 ], '' );
                    $rvm_region_array_sanitized[ 2 ] = rvm_sanitize_post_value( $rvm_region_array[ 2 ], 'html' );
                    $rvm_region_array_sanitized[ 4 ] = rvm_sanitize_post_value( $rvm_region_array[ 4 ], '' );
                ...
                $rvm_regions_data = wp_slash( serialize( $rvm_region_array_sanitized ) ); //escape quote with slash 
        ...
        if ( isset( $_POST[ 'rvm_marker_name' ] ) ) {
            if ( !empty( $_POST[ 'rvm_marker_name' ] ) ) {                
                $rvm_marker_name_sanitized = rvm_sanitize_post_value( $_POST[ 'rvm_marker_name' ], 'text' );
                $rvm_marker_name_serialize = wp_slash( serialize( $rvm_marker_name_sanitized ) );
            ...
            if ( !empty( $_POST[ 'rvm_marker_lat' ] ) ) {
                $rvm_marker_lat_array_sanitized = rvm_sanitize_post_value( $_POST[ 'rvm_marker_lat' ], 'num' );
                //$rvm_marker_lat_array_sanitized = rvm_check_is_number_in_array( $rvm_marker_lat_array_sanitized );
                $rvm_marker_lat_serialize = serialize( $rvm_marker_lat_array_sanitized );
            ...
            if ( !empty( $_POST[ 'rvm_marker_long' ] ) ) {
                $rvm_marker_long_array_sanitized = rvm_sanitize_post_value( $_POST[ 'rvm_marker_long' ], 'num' );
                //$rvm_marker_long_array_sanitized = rvm_check_is_number_in_array( $rvm_marker_long_array_sanitized );
                $rvm_marker_long_serialize = serialize( $rvm_marker_long_array_sanitized );
            ...
            if ( !empty( $_POST[ 'rvm_marker_link' ] ) ) {
                $rvm_marker_link_array_sanitized = rvm_sanitize_post_value( $_POST[ 'rvm_marker_link' ], 'url' );
                $rvm_marker_link_serialize = serialize( $rvm_marker_link_array_sanitized );
            ...
            if ( !empty( $_POST[ 'rvm_marker_dim' ] ) ) {
                $rvm_marker_dim_array_sanitized = rvm_sanitize_post_value( $_POST[ 'rvm_marker_dim' ], 'num' );
                //$rvm_marker_dim_array_sanitized = rvm_check_is_number_in_array( $rvm_marker_dim_array_sanitized );
                $rvm_marker_dim_serialize = serialize( $rvm_marker_dim_array_sanitized );
            ...
            if ( !empty( $_POST[ 'rvm_marker_popup' ] ) ) {
                $rvm_marker_popup_array_sanitized = rvm_sanitize_post_value( $_POST[ 'rvm_marker_popup' ], 'html' );
                $rvm_marker_popup_serialize = wp_slash( serialize( $rvm_marker_popup_array_sanitized ) ); //escape quote with slash
...
function add_new_rvm_columns( $columns )
{
    ...
    $new_columns[ 'title' ] = esc_html__( 'Map name', 'responsive-vector-maps' );
    $new_columns[ 'shortcode' ] = esc_html__( 'Shortcode', 'responsive-vector-maps' );
    $new_columns[ 'date' ] = esc_html__( 'Date', 'responsive-vector-maps' );
    return $new_columns;
}
...
function rvm_custom_columns( $column, $post_id )
{
    switch ( $column ) {
        case 'shortcode':
            echo '[rvm_map mapid="' . esc_html( $post_id ) . '"]';
            break;
    } //$column
}
